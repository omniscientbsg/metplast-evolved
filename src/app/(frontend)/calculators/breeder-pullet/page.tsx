...
export default function BreederPulletCalculatorPage() {
  ...
  const calculateBreederPullet = (values: Record<string, number>): CalculatorResult[] | { error: string } => {
    ...
    return [
      { title: 'Total Breeder Pullet Capacity', value: totalBirds.toLocaleString(), highlight: true },
  ...
  return (
    <div className="bg-[var(--bg)] min-h-screen">
      <CalculatorShell 
        ...
        onCalculate={calculateBreederPullet}
