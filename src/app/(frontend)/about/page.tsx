    ...
    <main className="min-h-screen bg-[var(--bg)] pt-32 pb-24 overflow-hidden relative text-[var(--text)]">
      ...
      <section className="px-6 mb-32 relative z-10 pt-20">
        <div className="max-w-[1400px] mx-auto text-center space-y-8">
          ...
          >
            <span className="text-sm font-bold tracking-widest uppercase" style={{ color: 'var(--accent)' }}>About Metplast</span>
          </motion.div>
          <motion.h1 
          ...
          >
            35+ YEARS OF <br/>
            <span className="text-gradient">POULTRY ENGINEERING.</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
